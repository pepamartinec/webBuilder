Ext.define( 'Inspirio.widget.TitleImage',
{
	...
	uses : [
		'Ext.DomHelper',
		'Ext.button.Button',
		'Inspirio.component.ImageSelectorPopup'
	],
	 ...
	 * @cfg {String} module
	 */
	module : '\\Inspirio\\Administration\\WebEditor\\ImageList',
	...
	popImageSelecter_onSubmit : function()
	{
		...
		if( me.popup == null ) {
			me.popup = Ext.create( 'Inspirio.component.ImageSelectorPopup', {
				env         : me.env,
				closeAction : 'hide',
