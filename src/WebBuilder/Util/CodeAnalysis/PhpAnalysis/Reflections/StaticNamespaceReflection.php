...
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\UnknownItemException;
use WebBuilder\Util\CodeAnalysis\RedeclarationException;
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\InvalidItemException;
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\UnexpectedEndOfSourceException;
...
class StaticNamespaceReflection implements NamespaceReflectionInterface, StaticReflectionInterface
{
	...
	public function getItem( $itemName )
	{
		if( !isset( $this->items[ $itemName ] ) ) {
			throw new UnknownItemException( "Item '{$itemName}' not found" );
		}
