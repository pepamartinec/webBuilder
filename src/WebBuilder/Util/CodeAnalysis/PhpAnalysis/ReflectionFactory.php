...
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\Reflections\DummyClassReflection;
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\Reflections\RuntimeClassReflection;
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\Reflections\DummyInterfaceReflection;
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\Reflections\RuntimeInterfaceReflection;
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\Reflections\FunctionReflectionInterface;
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\Reflections\ClassReflectionInterface;
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\Reflections\InterfaceReflectionInterface;
use WebBuilder\Util\CodeAnalysis\PhpAnalysis\Reflections\StaticNamespaceReflection;
use WebBuilder\Util\CodeAnalysis\InvalidFileException;
...
class ReflectionFactory
{
	...
	public function analyzeFile( $fileName )
	{
		...
		if( isset( $this->analyzedFiles[ $fileName ] ) === false ) {
	...
	protected function analyzeCode( Tokenizer $t, AliasResolver $r )
	{
		...
		} catch( UnexpectedEndOfSourceException $e ) {
			throw new InvalidSyntaxException( $e->getMessage(), null, $e );
		}
	}
	...
	public function getInterface( $name )
	{
		...
		if( $namespace->hasItem( $itName ) === false ) {
